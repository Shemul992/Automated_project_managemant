                  ...
                  <ul class = "navbar-nav mx-auto">
                    ...
                    @if (Auth::user()->role == 1)
                      <li class = "navbar-item active">
                        <a class = "nav-link" href="/projects"> Project ideas </a>
                      </li>
                      
                      <li class = "navbar-item active">
                        <a class = "nav-link" href="/projects"> Post Project Idea</a>
                      </li>
                    @elseif(Auth::user()->role == 2)
                      ...
                      <li class = "navbar-item active">
                        <a class = "nav-link" href="/projects"> Posted Ideas</a>
                      </li>
                ...
                <li class = "navabr-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    @if (Auth::user()->role == 1)
                      ...
                      <a href="#" class="dropdown-item  text-center">Assigned Projects</a>
                      <a href="view-all-students" class= "dropdown-item  text-center"> All students </a>
                    @else
                      <a href="#" class="dropdown-item  text-center">Applied projects </a>
                      <a href="#" class="dropdown-item  text-center">Got projects </a>
                    @endif
